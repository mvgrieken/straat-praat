...
export default function TranslateScreen() {
  ...
  const [_translationInput, _setTranslationInput] = useState('');
  const [_translationResult, _setTranslationResult] = useState<TranslationResultType | null>(null);
  const [_isTranslating, _setIsTranslating] = useState(false);
